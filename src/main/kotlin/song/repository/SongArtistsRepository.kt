...
interface SongArtistsRepository : JpaRepository<SongArtistsEntity, Long> {
    ...
    @Query("SELECT a FROM song_artists a JOIN FETCH a.song LEFT JOIN FETCH a.artist LEFT JOIN FETCH a.song.playlistSongs JOIN FETCH a.song.album JOIN FETCH a.song.album.artist  JOIN FETCH a.artist.songArists WHERE a.song.title like %:keyword%")
