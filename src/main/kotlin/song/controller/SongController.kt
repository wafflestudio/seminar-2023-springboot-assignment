...
class SongController(
    ...
    fun searchSong(
        ...
        val songs = songService.search(keyword =keyword)
        return SearchSongResponse(songs = songs)
    }
    ...
    fun searchAlbum(
        ...
        val albums = songService.searchAlbum(keyword = keyword)
        return SearchAlbumResponse(albums = albums)
    }
}
