...
class SongController(
    ...
    fun searchSong(
        ...
        val songList = songService.search(keyword)
        return SearchSongResponse(songs = songList)
    }
    ...
    fun searchAlbum(
        ...
        val albumList = songService.searchAlbum(keyword)
        return SearchAlbumResponse(albums = albumList)
    }
}
